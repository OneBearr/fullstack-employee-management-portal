...
export const hr_GetAllPersonalInfoAPI = async (token) =>{
    const response = await fetch("http://localhost:3000/api/hrApplications", {
        method: 'GET',
        headers: {
            "x-auth-token": token,
        },
...
export const hr_GetTokenHistory = async (token) => {
